...
\begin{definition}
Let $G$ be a graph with no self-loops on the torus.
...
Push the top strand to the bottom strand,
splitting the crossing edge into two
identical edges and spreading them apart
as in Figure \ref{fig:crossingArc} right.
We push the link
