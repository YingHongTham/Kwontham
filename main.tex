...
% awkward attempts to address necessity of bigon condition
% in main theorem
%\begin{remark}
%In the torihedral decomposition of $L$
%(as in \prpref{p:tori_decomp}),
%a string of bigons would
%produce bow-tie graphs whose total number 
%of edges identified is greater than 4 
%
%
%We put restrictions on bigons for the following reason.
%Recall from \prpref{p:tori_decomp} that
%a link complement is obtained from identifying
%certain collections of edges from the top and bottom torihedra.
%When there are non-augmented bigons,
%some of these collections would not be 
%\end{remark}
