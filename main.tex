...
regions (a single crossing or a string of bigons) of $K$. The added circle
...
are removed. The newly obtained link is called an \emph{augmented link} and the
newly obtained diagram is called an \emph{augmented link diagram}. See Figure
...
alternating links in $\Sp^3$ into two polyhedra, a top polyhedron and a bottom
