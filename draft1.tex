...
showed that there is a decomposition of the complement of $K$ into objects called torihedra, which we think of 
as counterparts of Menasco's decomposition of links in $\Sp^3$ into polyhedra, for links in the thickened 
torus. Just like Menasco's decomposition, one can obtain a top and bottom torihedron. In section 2 we show that for augmented links in the thickened torus 
